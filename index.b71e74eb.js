...
})({"ce9fv":[function(require,module,exports) {
...
var _renderJs = require("./script/render.js");
$(window).on("load", (e)=>{
    (0, _renderJs.renderRecomendedFurnitureItem)();
    (0, _renderJs.renderCourselFurnitureItem)();
    ...
    $(window).on("scroll", (e)=>{
        ...
        if (scroll && scroll > 10) $("header").addClass("shadow");
...
},{"./script/render.js":"gS9P0"}],"gS9P0":[function(require,module,exports) {
/// <reference types="jquery" />
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderRecomendedFurnitureItem", ()=>renderRecomendedFurnitureItem);
parcelHelpers.export(exports, "renderCourselFurnitureItem", ()=>renderCourselFurnitureItem);
var _apiJs = require("./api.js");
var _itemsCourselJs = require("./itemsCoursel.js");
...
const renderRecomendedFurnitureItem = async ()=>{
    ...
    />
        ...
        const data = await (0, _apiJs.getFurnitures)();
...
const renderCourselFurnitureItem = async ()=>{
    try {
        ...
        (0, _itemsCourselJs.CourselSetup)();
    } catch (error) {
        console.log(error);
        console.error("can not get data from api");
    }
...
},{"./api.js":"hCSbc","./itemsCoursel.js":"4I0iW","@parcel/transformer-js/src/esmodule-helpers.js":"3dkiX"}],"hCSbc":[function(require,module,exports) {
/// <reference types="jquery" />
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getFurnitures", ()=>getFurnitures);
...
},{}],"4I0iW":[function(require,module,exports) {
/// <reference types="jquery" />
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CourselSetup", ()=>CourselSetup);
...
const CourselSetup = ()=>{
    ...
    $(".product__list__coursel__control__left").on("click", (e)=>{
        ...
        if (prev.length > 0) {
            ...
            active.removeClass("product__list__coursel__item--active");
            $(".product__list__coursel__item").last().addClass("product__list__coursel__item--active");
        }
    ...
    $(".product__list__coursel__control__right").on("click", (e)=>{
        ...
        if (next.length > 0) {
            ...
            active.removeClass("product__list__coursel__item--active");
            $(".product__list__coursel__item").first().addClass("product__list__coursel__item--active");
        }
        scrollIfCourselOverflow();
    });
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"3dkiX"}]},["ce9fv","h7u1C"], "h7u1C", "parcelRequire8a9c")
